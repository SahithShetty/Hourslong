...
$plan = new Plan();
$plan->setName('Hourslong monthly subscription')
  ->setDescription('Gives you access to all the premium features of our site.')
  ->setType('INFINITE');
...
$merchantPreferences->setReturnUrl($returnUrl . "?success=true")
  ...
  ->setSetupFee(new Currency(array('value' => 4.99, 'currency' => 'USD')));
